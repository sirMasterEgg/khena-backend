...
// Wiring terpisah dari public-checkout.route.ts (konvensi repo ini: tiap
// *.route.ts membangun graf dependency sendiri, tidak ada DI container
// bersama) — webhook hanya memakai method handleMidtransNotification.
...
export const PublicPaymentRoute = (app: Elysia) =>
  app.use(PublicPaymentController(service));
